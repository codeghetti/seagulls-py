...
from seagulls.cat_demos.app._component_providers import CatDemosAppSettings, CatDemosComponentProviders, ProcessType
...
class CatDemosDiContainer:
    ...
    def _launch_command(self) -> GameCliCommand:
        return GameCliCommand(app=self.app(), app_providers_factory=self._standalone_providers())

    @lru_cache()
    def _dev_command(self) -> GameCliCommand:
        return GameCliCommand(app=self.app(), app_providers_factory=self._client_providers())
