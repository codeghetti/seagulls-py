...
class ContextualGameComponentContainer(GameComponentContainer, Generic[T]):
    ...
    def __init__(self, container: GameComponentContainer, context: ServiceProvider[T]) -> None:
    ...
    @lru_cache()
    def _get(self, component_id: GameComponentId[GameComponentType], context: T) -> GameComponentType:
...
class FilteredGameComponentRegistry(GameComponentContainer):
    ...
    def __init__(self, container: GameComponentContainer, context: ServiceProvider[Iterable[GameComponentId]]) -> None:
        self._container = container
        self._context = context
